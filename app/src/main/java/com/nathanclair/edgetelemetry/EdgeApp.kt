...
class EdgeApp: Application() {
    ...
    override fun onCreate() {
        ...
        val config = EdgeTelemetryConfig.builder()
            ...
            .setTracesEndpoint("https://05d7-41-90-172-101.ngrok-free.app/ingest")
            .setLogsEndpoint("https://05d7-41-90-172-101.ngrok-free.app/ingest")
            .setMetricsEndpoint("https://05d7-41-90-172-101.ngrok-free.app/ingest")
